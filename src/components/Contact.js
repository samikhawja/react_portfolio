      ...
      <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          ...
          <div className="bg-gray-900 relative flex flex-wrap py-6 w-96 rounded shadow-md">
            ...
            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
              ...
              <a href="mailto:Skhawja11@gmail.com" className="text-indigo-400 leading-relaxed">
                Skhawja11@gmail.com
              </a>
        ...
        <form
          ...
          <p className="leading-relaxed mb-5">
            Fill out the information below to get into contact with me! I look forward to your email!
          </p>
          ...
          <div className="relative mb-4">
            ...
            <textarea
              id="message"
              name="message"
              placeholder="Come work for us, Sami!"
